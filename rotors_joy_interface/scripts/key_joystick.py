...
def main():
    ...
    pitch_stick = stick_state('Pitch', uinput.ABS_Y, K_DOWN, K_UP)
    pitch_stick.set_display(328, 198, False)
    sticks.append(pitch_stick)
    thr_stick = stick_state('Throttle', uinput.ABS_THROTTLE, K_s, K_w, False)
    thr_stick.set_display(328, 95, False)
    sticks.append(thr_stick)
    rud_stick = stick_state('Yaw', uinput.ABS_RUDDER, K_a, K_d)
